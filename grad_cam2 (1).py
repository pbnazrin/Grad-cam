...
Original file is located at
    https://colab.research.google.com/drive/1vmfy1gQ1eK4WRVUgDjGOWVu5ygnj7_mJ
"""
...
def GradCam(model, img_array, layer_name):
    ...
    #print("img_pred_shape = ", y_c.shape)
...
def GradCam1(model, img_array, layer_name):
    #cls = np.argmax(model.predict(img_array))
...
def ScoreCam(model, img_array, layer_name, max_N=-1):
  ...
  # 5. define weight as the score of target class
    ...
    weights=weights.reshape(96,32,96)
    print("act",act_map_array[0,:,:,:].shape)
